...
-- Event:
    ...
    KEEP_PETS = { ["Toucan"] = 3, ["Mochi Mouse"] = 2, ["Spaghetti Sloth"] = 5, ["Bagel Bunny"] = 1, "Spaghetti Sloth", "French Fry Ferret", ["Corrupted Kodama"] = 7, ["Kodama"] = 4, "Corrupted Kitsune", ["Starfish"] = 10, "Kitsune", ["Kappa"] = 1, "Fennec Fox", "Disco Bee", "Raccoon", "Queen Bee", "Dragonfly", "Butterfly", "Mimic Octopus", "Brontosaurus", "T-Rex", "Spinosaurus", "Ankylosaurus", "Dilophosaurus", ["Capybara"] = 2, [ "Seal"] = 2, "Red Fox", "Tanchozuru", ["Tanuki"] = 1, ["Ostrich"] = 1, ["Raiju"] = 2},
    KEEP_PETS_WEIGHT = 5,

    -- EQUIP_PETS Priority (Left -> Right)
    EQUIP_PETS = { ["Toucan"] = 2, ["Capybara"] = 1, ["Starfish"] = 7},
